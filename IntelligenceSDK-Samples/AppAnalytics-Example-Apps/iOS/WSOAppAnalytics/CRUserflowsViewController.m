...
- (void)performCommand:(NSString *)what forUserflow:(NSString *)txName {
  ...
  if ([what isEqualToString:@"Begin"]) {
    ...
    [[[UIAlertView alloc] initWithTitle:txName message:[NSString stringWithFormat:@"Userflow value = %i", [Crittercism valueForUserflow:txName]] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] show];
  } else {
