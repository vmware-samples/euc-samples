...
identify_latest_update=$(/usr/bin/printf "%s\n" $(/usr/sbin/pkgutil --pkgs=".*MRT.*") | sort -k1 | tail -1)
...
# Description: Returns Malware Removal Tool (MRT) version info. Attributed to https://gist.githubusercontent.com/rtrouton/d70170eb5cfc5410041931bff412c11d/raw/42ce26a3a4ae5851551a45043f7eb1c66458a506/check_latest_Xprotect_Gatekeeper_MRT_update.sh
